      ...
      <div className="flex flex-wrap items-center justify-between mb-3">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          >
            ...
            <span className="">New Account Group</span>
          </button>
        </div>
      </div>
        ...
        <table className="w-full text-sm text-left text-gray-800 rounded">
          <thead className="text-xs text-slate-800 bg-slate-200 shadow-sm border-y border-slate-300">
            <tr>
              ...
              <th className="p-2">Account Group Code</th>
              <th className="p-2">Account Group</th>
              <th className="p-2">Account Sub Group</th>
                  ...
                  <td className="p-2">
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        onClick={() => deleteHandler(accountGroup._id)}
...
export default ViewAccountGroups;
