...
const schemaName = ChannelPartner;
const schemaNameString = "ChannelPartner";
...
export const putChannelPartner = async (req, res) => {
  try {
    const { id } = req.params;
    const {
      channelPartnerSerialNo,
      registrationDate,
      state,
      city,
      introductionID,
    ...
    object.panNumber = panNumber;
    object.planType = planType;
    object.bankAccountNumber = bankAccountNumber;
    object.IFSCCode = IFSCCode;
